...
def resolve_doi(doi: str) -> str:
    from literature_download import crossref_search
...
def download_pdf(identifier: str, source: str = "arxiv", output_dir: str = "./library/pdfs") -> str:
    from literature_download import arxiv_search, crossref_search, ieee_search
